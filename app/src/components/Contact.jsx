        ...
        <section className="contact-section" id="contacto">
            <div className="container">
                ...
                >
                    ...
                    <h2>
                        Hablemos.
                        <a href="https://wa.me/595992296146" target="_blank" rel="noopener noreferrer" className="contact-arrow-btn" aria-label="Contactar por WhatsApp">
                ...
                <div className="footer-content">
                    <div className="footer-col">
                        <div className="social-icons">
                            ...
                            <a href="https://wa.me/595992296146" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                    ...
                    <div className="footer-col">
                        ...
                        <a href="https://wa.me/595992296146" target="_blank" rel="noopener noreferrer" className="footer-value">
                            +595 992 296146
                        </a>

                        <span className="footer-label" style={{ marginTop: '24px' }}>Email</span>
                        <a href="mailto:malizgomezz@gmail.com" className="footer-value" style={{textDecoration: 'underline'}}>
                            malizgomezz@gmail.com
                        </a>
                    </div>

                    <div className="footer-col">
                        <span className="footer-label">LinkedIn</span>
                        <a href="https://www.linkedin.com/in/mar%C3%ADa-liz-gomez-6061a7151/" target="_blank" rel="noopener noreferrer" className="footer-value">
                            Maly Gomez
                        </a>
                        
                        <span className="footer-label" style={{ marginTop: '24px' }}>Instagram</span>
                        <a href="https://www.instagram.com/malygm/" target="_blank" rel="noopener noreferrer" className="footer-value">
                            @malygm
                        </a>
                    </div>
                </div>
